  ...
  return (
    <div className="relative flex items-center group">
      <div className="h-9 w-9 relative overflow-hidden rounded-lg">
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-black to-gray-800 rounded-md animate-float"></div>
      ...
      <div className="ml-2 flex flex-col">
        <span className="font-semibold text-xl tracking-tight text-white group-hover:translate-x-0.5 transition-transform duration-300">CodeCanvas</span>
